...
// option 2
function getUniqueSuppliers2(products) {
  let arrSuppliers = products.map((product) => {
    return product.supplier;
  });
  let uniqueSuppliers = {};
  arrSuppliers.forEach((arrSupplier) => {
    uniqueSuppliers[arrSupplier] = true;
  });
  return Object.keys(uniqueSuppliers);
}
const resultUniqueSuppliers2 = getUniqueSuppliers2(data);
console.log("17. Array Of Unique Suppliers2: ", resultUniqueSuppliers2);
