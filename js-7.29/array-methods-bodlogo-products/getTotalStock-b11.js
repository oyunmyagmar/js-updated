...
// option 2
function getTotalStock2(products) {
  let totalStockOfAllProducts = 0;
  for (let i = 0; i < products.length; i++) {
    totalStockOfAllProducts += products[i].stock;
  }
  return totalStockOfAllProducts;
}
const resultTotalStock = getTotalStock2(data);
console.log("11. Total Stock Of All Products2: ", resultTotalStock);
