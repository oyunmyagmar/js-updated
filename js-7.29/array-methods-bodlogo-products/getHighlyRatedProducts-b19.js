...
// option 2
function getHighlyRatedProducts2(products) {
  let highlyRatedProducts = products.filter((product) => {
    return product.rating > 4.5;
  });
  return highlyRatedProducts;
}
const resultHighlyRatedProducts2 = getHighlyRatedProducts2(data);
console.log("Highly Rated Products2: ", resultHighlyRatedProducts2);
