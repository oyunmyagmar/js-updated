...
console.log("10. Cheapest Product: ", resultCheapestProduct);

// option 2
function getCheapestProduct2(products) {
  let cheapestProduct = products[0];
...
const resultCheapestProduct2 = getCheapestProduct2(data);
console.log("10. Cheapest Product2: ", resultCheapestProduct2);
