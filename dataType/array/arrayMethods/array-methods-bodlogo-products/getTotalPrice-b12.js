...
// option 2
function getTotalPrice2(products) {
  let totalPriceOfAllProducts = 0;
  for (let i = 0; i < products.length; i++) {
    totalPriceOfAllProducts += products[i].price;
  }
  return totalPriceOfAllProducts;
}
const resultTotalPriceAllProducts = getTotalPrice2(data);
console.log("12. Total Price Of All Products2: ", resultTotalPriceAllProducts);
